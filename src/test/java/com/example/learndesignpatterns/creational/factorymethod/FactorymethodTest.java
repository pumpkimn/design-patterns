package com.example.learndesignpatterns.creational.factorymethod;
...
public class FactorymethodTest extends LearnDesignPatternsApplicationTests {
    ...
    public void testFactoryMethod() {
        ...
        Assert.assertEquals("com.example.learndesignpatterns.creational.factorymethod.ConcreteProductA"
        ,productA.getClass().getName());
        Assert.assertEquals("com.example.learndesignpatterns.creational.factorymethod.ConcreteProductB"
